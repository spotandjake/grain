...
## [0.6.0](https://github.com/spotandjake/grain/compare/grain-v0.5.13...grain-v0.6.0) (2023-03-16)
...
* **compiler:** Disallow multiple `provide`s of the same value (#1689)
...
* Add npm releases to workflow ([#948](https://github.com/spotandjake/grain/issues/948)) ([d55bbc0](https://github.com/spotandjake/grain/commit/d55bbc081c5dffb4532b0abca838716d969a919b))
...
* **cli:** Refactor forwardable options ([#908](https://github.com/spotandjake/grain/issues/908)) ([9ecb49b](https://github.com/spotandjake/grain/commit/9ecb49b7fc29ab8cb09baefe512471c07b9dbdc6))
* **compiler:** Add `--memory-base` flag ([#1115](https://github.com/spotandjake/grain/issues/1115)) ([0680826](https://github.com/spotandjake/grain/commit/068082663c4387c3ab54c052869e9b9a06b87e26))
* **compiler:** Add `[@unsafe](https://github.com/unsafe)` attribute for low-level code ([#1074](https://github.com/spotandjake/grain/issues/1074)) ([212faca](https://github.com/spotandjake/grain/commit/212faca9a8363002cfc0cb4e3ea293180cbe5b1c))
...
* **compiler:** Add typed well-formedness pass which forbids usage of WasmXX values outside of `[@disable](https://github.com/disable)GC` context ([#772](https://github.com/spotandjake/grain/issues/772)) ([42fbad6](https://github.com/spotandjake/grain/commit/42fbad632f1f7137285dbf4dbe609ddfb91c956e))
...
* **compiler:** Add warning for calls to IntXX.fromNumber and FloatXX.fromNumber with literal integers/floats ([#1218](https://github.com/spotandjake/grain/issues/1218)) ([2fb86e5](https://github.com/spotandjake/grain/commit/2fb86e538a9d38241d6c149cec1a290817795b4b))
...
* **compiler:** Allow [@external](https://github.com/external)Name attribute for foreign names ([#1060](https://github.com/spotandjake/grain/issues/1060)) ([f4c1311](https://github.com/spotandjake/grain/commit/f4c13115ef2eb589f035c31370e56a12bdc2e10c))
...
* **compiler:** Allow a newline character before a match guard ([#1063](https://github.com/spotandjake/grain/issues/1063)) ([bf41a9c](https://github.com/spotandjake/grain/commit/bf41a9cf585c63eb2482c7d94d9c615428bc8435))
...
* **compiler:** Allow function re-exports to use regular call instruction ([#1176](https://github.com/spotandjake/grain/issues/1176)) ([afce3aa](https://github.com/spotandjake/grain/commit/afce3aaa5382cde54b1e8fd9be3d2ee86daedbbb))
...
* **compiler:** Arbitrary-Precision Integer Arithmetic ([#1167](https://github.com/spotandjake/grain/issues/1167)) ([6f34de2](https://github.com/spotandjake/grain/commit/6f34de214b28358ea1df553685fa3a19336ddba9))
...
* **compiler:** Call known functions across module boundaries ([#1175](https://github.com/spotandjake/grain/issues/1175)) ([b2d7440](https://github.com/spotandjake/grain/commit/b2d744034ec7e0601554531c910e9d0f5451d464))
...
* **compiler:** Cleaner wasm output for low-level wasm types ([#1158](https://github.com/spotandjake/grain/issues/1158)) ([88060dd](https://github.com/spotandjake/grain/commit/88060ddb8119e2998d91f4d6770a1cfd101936cf))
* **compiler:** Consolidate exe & js modes ([fc61950](https://github.com/spotandjake/grain/commit/fc6195013457dd29f78951322bfaf2ae27c1bdd2))
* **compiler:** Convert `runtime/dataStructures.gr` to primitives ([#1145](https://github.com/spotandjake/grain/issues/1145)) ([2d43b28](https://github.com/spotandjake/grain/commit/2d43b286141df75f6b92300e48d2bc4804014872))
* **compiler:** Convert Sys libraries to [@unsafe](https://github.com/unsafe) ([#1272](https://github.com/spotandjake/grain/issues/1272)) ([fcdfc2a](https://github.com/spotandjake/grain/commit/fcdfc2a815be889d5f0424a04dd5b2373dbd983b))
...
* **compiler:** Don't close over global values ([#1134](https://github.com/spotandjake/grain/issues/1134)) ([e8caec6](https://github.com/spotandjake/grain/commit/e8caec6c2a5892e955c8827b18d8d436bebe6073))
...
* **compiler:** Inline all primitives ([#1076](https://github.com/spotandjake/grain/issues/1076)) ([c227130](https://github.com/spotandjake/grain/commit/c2271307b7220d54dc1c252dfc4ee5532f68dd29))
* **compiler:** Inline not `(!)` operator ([#937](https://github.com/spotandjake/grain/issues/937)) ([3f5e9a9](https://github.com/spotandjake/grain/commit/3f5e9a962ec8565f4fb79a1ee36d7b492da5cf11))
...
* **compiler:** Name globals in wasm output ([#1184](https://github.com/spotandjake/grain/issues/1184)) ([51170e7](https://github.com/spotandjake/grain/commit/51170e7c892680f9c730b7f93cf744ffd6b7c15a))
...
* **compiler:** Re-implement Grain parser ([#1033](https://github.com/spotandjake/grain/issues/1033)) ([9dc3c96](https://github.com/spotandjake/grain/commit/9dc3c96f87a0b2affe9db36e1b03360d198f79f1))
...
* **compiler:** Reduce closure sizes by utilizing `$self` argument when possible ([#1152](https://github.com/spotandjake/grain/issues/1152)) ([ba6a84c](https://github.com/spotandjake/grain/commit/ba6a84cea191cf3c7932287c29b198001d490146))
...
* **compiler:** Refactor exports ([#1244](https://github.com/spotandjake/grain/issues/1244)) ([4637667](https://github.com/spotandjake/grain/commit/4637667cd669c0988cd01c2957534c6a35a3146c))
...
* **compiler:** Selectively include functions in the global function table ([#1183](https://github.com/spotandjake/grain/issues/1183)) ([67575f7](https://github.com/spotandjake/grain/commit/67575f712557bc36531f6e40044d1bbfff2454ff))
...
* **compiler:** Stack-allocated Chars ([#1103](https://github.com/spotandjake/grain/issues/1103)) ([095385e](https://github.com/spotandjake/grain/commit/095385e7c67bbc7a417a21acaf6f1c498c75ce63))
...
* **compiler:** Support pattern aliases ([#1174](https://github.com/spotandjake/grain/issues/1174)) ([9ed093b](https://github.com/spotandjake/grain/commit/9ed093be353895bdde8282ee1681089d5fac68ab))
* **compiler:** Support pattern matching "or" patterns ([#1173](https://github.com/spotandjake/grain/issues/1173)) ([0fb29c4](https://github.com/spotandjake/grain/commit/0fb29c4016e1b24b9e3b3b640cc9914b921ec376))
...
* **compiler:** Type aliases ([#995](https://github.com/spotandjake/grain/issues/995)) ([bc648ce](https://github.com/spotandjake/grain/commit/bc648ce98f1263cdb4163f7fd620de75771848ab))
...
* **compiler:** Upgrade binaryen to 0.15.0 to support Mac M1 arch ([#1151](https://github.com/spotandjake/grain/issues/1151)) ([fc61950](https://github.com/spotandjake/grain/commit/fc6195013457dd29f78951322bfaf2ae27c1bdd2))
* **compiler:** Use symbol for equals sign ([#1128](https://github.com/spotandjake/grain/issues/1128)) ([3d7fc57](https://github.com/spotandjake/grain/commit/3d7fc5742ad3016d60e14112fdd68de02fc147f1))
...
* **graindoc:** Add `--current-version` flag, required for since/history attributes ([#1116](https://github.com/spotandjake/grain/issues/1116)) ([0f681ea](https://github.com/spotandjake/grain/commit/0f681ea140749395f3ce99a460f30778537183ac))
...
* **graindoc:** Allow directory input & output ([#1263](https://github.com/spotandjake/grain/issues/1263)) ([d4cb8ab](https://github.com/spotandjake/grain/commit/d4cb8abcb4accafeb3cae0bac77eee9a365e464d))
...
* **grainfmt:** Add format in place or output to a new file ([#904](https://github.com/spotandjake/grain/issues/904)) ([0d18935](https://github.com/spotandjake/grain/commit/0d1893576bf3ad9e4d5c3aca5bfa963966b84b66))
...
* **grainfmt:** Drastically improve performance ([#1042](https://github.com/spotandjake/grain/issues/1042)) ([9bc7a55](https://github.com/spotandjake/grain/commit/9bc7a55a525c8018e9d915cf94af2f2486a21e27))
...
* **stdlib:** Add Conv.wasmI32ToNumber function ([#978](https://github.com/spotandjake/grain/issues/978)) ([c93ade8](https://github.com/spotandjake/grain/commit/c93ade873b51acca556e19a7483a5f29b4b6caa9))
* **stdlib:** Add cycle function to Array module ([#993](https://github.com/spotandjake/grain/issues/993)) ([c595622](https://github.com/spotandjake/grain/commit/c595622b28366655dfd5447270e8f9fc3f988a67))
* **stdlib:** Add module for pseudo-random number generation ([#921](https://github.com/spotandjake/grain/issues/921)) ([db1fa4e](https://github.com/spotandjake/grain/commit/db1fa4e491d35bb582beaba12157884647384a77))
...
* **stdlib:** Add reverse function to String module ([#1027](https://github.com/spotandjake/grain/issues/1027)) ([df761db](https://github.com/spotandjake/grain/commit/df761db55b3e14e31190090ae008ce5047135c09))
* **stdlib:** Add rotate function in Array module ([#838](https://github.com/spotandjake/grain/issues/838)) ([98fc577](https://github.com/spotandjake/grain/commit/98fc577ee754317cd2421bfaa8e3c1e049488949))
* **stdlib:** Add sign function to Number module ([#1079](https://github.com/spotandjake/grain/issues/1079)) ([b6483d5](https://github.com/spotandjake/grain/commit/b6483d5046cd1b6b89a717a925594d3b20b05837))
* **stdlib:** Add sort function to Array module ([#1012](https://github.com/spotandjake/grain/issues/1012)) ([9091930](https://github.com/spotandjake/grain/commit/9091930344224925bb7b2e1ef6f879c79a5c2f62))
* **stdlib:** Add string trim functions to String module ([#951](https://github.com/spotandjake/grain/issues/951)) ([e55de8f](https://github.com/spotandjake/grain/commit/e55de8fc0335b45252da9741a80b46a702cdb5b6))
* **stdlib:** Add unsigned versions of Int32/Int64 comparison operations ([#831](https://github.com/spotandjake/grain/issues/831)) ([5f20868](https://github.com/spotandjake/grain/commit/5f20868e7b6e3f52d62c8531d99d1130ca84961e))
...
* **stdlib:** Added Bytes.clear function. Avoid allocation in Buffer.clear ([#1124](https://github.com/spotandjake/grain/issues/1124)) ([4afd17a](https://github.com/spotandjake/grain/commit/4afd17a91e59027fa7af0fe58977bdbe942f8072))
...
* **stdlib:** Convert runtime printing utils to [@unsafe](https://github.com/unsafe) ([#1135](https://github.com/spotandjake/grain/issues/1135)) ([403e1d2](https://github.com/spotandjake/grain/commit/403e1d20e2082fe2dcd2721f83f6c2b36d4154bf))
...
* **stdlib:** Implement List.sort via mergesort ([#1014](https://github.com/spotandjake/grain/issues/1014)) ([a076e20](https://github.com/spotandjake/grain/commit/a076e200013114ccf16c2e6cbe814af1ec09c1ce))
* **stdlib:** Implement List.zip, List.unzip, List.zipWith, Array.reduceRight, Array.zipWith ([#1363](https://github.com/spotandjake/grain/issues/1363)) ([3e7c147](https://github.com/spotandjake/grain/commit/3e7c147fea2d2fb8b7c5a3d6b3eb1453f2861e36))
...
* **stdlib:** Number.parseInt ([#1051](https://github.com/spotandjake/grain/issues/1051)) ([abafb58](https://github.com/spotandjake/grain/commit/abafb587e54219a32ed77ba09863bb2d6a80bac8))
...
* **stdlib:** Regular Expressions ([#680](https://github.com/spotandjake/grain/issues/680)) ([9601e16](https://github.com/spotandjake/grain/commit/9601e1655f1ffc76b700efef317366457c5614ef))
...
* **stdlib:** Support zipping arrays of different sizes ([#1402](https://github.com/spotandjake/grain/issues/1402)) ([b8ae3d6](https://github.com/spotandjake/grain/commit/b8ae3d69c98ada45bc592fb3097f21bc8a0d40bd))
...
* **cli:** Forward stdlib option to lsp and graindoc ([#916](https://github.com/spotandjake/grain/issues/916)) ([07c5237](https://github.com/spotandjake/grain/commit/07c5237795c9717cf925c6889e165f4eb8a04f8d))
* **cli:** Manually bump CLI dependencies ([#871](https://github.com/spotandjake/grain/issues/871)) ([1e4a7a1](https://github.com/spotandjake/grain/commit/1e4a7a171c8dd41caf54e6218d59dffafef8f226))
* **cli:** Only add --experimental-wasm-bigint flag on node 14 or 15 ([#899](https://github.com/spotandjake/grain/issues/899)) ([1cc0c5c](https://github.com/spotandjake/grain/commit/1cc0c5c03d38957c90f71e99a188c448923a481c))
...
* **compiler:** Account for config that is not digestable ([#1098](https://github.com/spotandjake/grain/issues/1098)) ([b58323f](https://github.com/spotandjake/grain/commit/b58323f1764f4d870875b8c4ef19f9861b4188ad))
...
* **compiler:** Allow modules to re-export imported types containing generics ([#1019](https://github.com/spotandjake/grain/issues/1019)) ([003cb1e](https://github.com/spotandjake/grain/commit/003cb1e10ca51c3f16d2155581eb8dccdde3ce5c))
* **compiler:** Allow trailing commas in imports and destructuring ([#890](https://github.com/spotandjake/grain/issues/890)) ([f5c24c9](https://github.com/spotandjake/grain/commit/f5c24c946b3356090b9aca6123bc14a19b4e06fb))
* **compiler:** Apply correct allocation type to numbers ([#1140](https://github.com/spotandjake/grain/issues/1140)) ([b9e9d59](https://github.com/spotandjake/grain/commit/b9e9d59143f529f7c0ae100b048988e6ba0e8d54))
...
* **compiler:** Apply optimization flag at link stage ([#1099](https://github.com/spotandjake/grain/issues/1099)) ([49dac79](https://github.com/spotandjake/grain/commit/49dac797aa4833cc141f7c58d18d80d7cbc6b1c7))
...
* **compiler:** Consider invalid CMIs as out of date and recompile ([#1061](https://github.com/spotandjake/grain/issues/1061)) ([80da3a9](https://github.com/spotandjake/grain/commit/80da3a9667020e4f5f855a0b9da8286508a07275))
...
* **compiler:** Correctly supply locations for types & variants ([9bc7a55](https://github.com/spotandjake/grain/commit/9bc7a55a525c8018e9d915cf94af2f2486a21e27))
...
* **compiler:** Do not inline aliased mutables ([#909](https://github.com/spotandjake/grain/issues/909)) ([a50430a](https://github.com/spotandjake/grain/commit/a50430a2cff5f50dd666f1ec14bd485bfda77e86))
* **compiler:** Don't over-optimize mutable imports ([#967](https://github.com/spotandjake/grain/issues/967)) ([c3066f6](https://github.com/spotandjake/grain/commit/c3066f6e32bbbe3bd51b9a7b498567b8deb8d9ba))
* **compiler:** Don't warn on exhaustive boolean matches ([#913](https://github.com/spotandjake/grain/issues/913)) ([4189745](https://github.com/spotandjake/grain/commit/4189745d09c3fc6971f95dc1c8428dc73761aed3))
* **compiler:** Ensure cwd directory is normalized on Windows ([#952](https://github.com/spotandjake/grain/issues/952)) ([a3ab9c3](https://github.com/spotandjake/grain/commit/a3ab9c3cd2359866a61a1dd4b63f40b0f964e2a4))
* **compiler:** Ensure main module is included in linker dependency graph ([#996](https://github.com/spotandjake/grain/issues/996)) ([d5c6c04](https://github.com/spotandjake/grain/commit/d5c6c048d4239ef07fb6ac0a79774d85933cccf9))
* **compiler:** Ensure TExpApp is always expansive in Grain ([ef0a69f](https://github.com/spotandjake/grain/commit/ef0a69fb4418d318b3227e5db7e743a026762274))
* **compiler:** Export functions with aliased names as wasm functions ([#920](https://github.com/spotandjake/grain/issues/920)) ([afba142](https://github.com/spotandjake/grain/commit/afba142ef90d0d95ae0085debe50e1b34588b267))
* **compiler:** Fix binop operator reported location ([#1018](https://github.com/spotandjake/grain/issues/1018)) ([422dbcb](https://github.com/spotandjake/grain/commit/422dbcb01cd09627c6a5f4494cc7c2e7644e92f0))
...
* **compiler:** Fix counting of stack size ([#1066](https://github.com/spotandjake/grain/issues/1066)) ([f1b3e51](https://github.com/spotandjake/grain/commit/f1b3e51580062da9b7e42ec36eb9880b71375cb9))
...
* **compiler:** Fix error message when trying to export a constructor ([#1055](https://github.com/spotandjake/grain/issues/1055)) ([54ddb67](https://github.com/spotandjake/grain/commit/54ddb671745b554eacc8640b1337a46f423b1cc5))
...
* **compiler:** Fix memory leaks when loading from heap values ([#1038](https://github.com/spotandjake/grain/issues/1038)) ([7d3402d](https://github.com/spotandjake/grain/commit/7d3402db09b6e4e24e49d168e8ddd49044a98df1))
* **compiler:** Fix parsing of block with lone 0-arg enum ([#885](https://github.com/spotandjake/grain/issues/885)) ([edfc21e](https://github.com/spotandjake/grain/commit/edfc21e0ca8f76f00b53d0fd07075ccf6299358e))
...
* **compiler:** Fix stack/heap number allocation boundary ([#974](https://github.com/spotandjake/grain/issues/974)) ([47b0f56](https://github.com/spotandjake/grain/commit/47b0f56c00e88ddc6054b8f8f8eea4b21da0c7f7))
* **compiler:** Follow proper calling convention when callling stdlib equals in match ([#895](https://github.com/spotandjake/grain/issues/895)) ([73fe7d4](https://github.com/spotandjake/grain/commit/73fe7d47783a76454496c8bba55ff051561ef975))
...
* **compiler:** Handle let-mut value restriction, such that mutable lets are always expansive ([ef0a69f](https://github.com/spotandjake/grain/commit/ef0a69fb4418d318b3227e5db7e743a026762274))
...
* **compiler:** Inform the compiler that lsp mode is running on a root file ([b58323f](https://github.com/spotandjake/grain/commit/b58323f1764f4d870875b8c4ef19f9861b4188ad))
...
* **compiler:** Move Filename usage to Filepath.String & normalize separators ([584bcad](https://github.com/spotandjake/grain/commit/584bcad942f91d86c9b328e61f34af6e3cfbd050))
* **compiler:** Move lsp flag into grainc to remove it as a recompilation flag ([b58323f](https://github.com/spotandjake/grain/commit/b58323f1764f4d870875b8c4ef19f9861b4188ad))
* **compiler:** Panic immediately when out of memory ([#1450](https://github.com/spotandjake/grain/issues/1450)) ([943d47d](https://github.com/spotandjake/grain/commit/943d47dddde2d88fd96727e9d7ed8501efec42ef))
* **compiler:** Parse array set with newline correctly ([#926](https://github.com/spotandjake/grain/issues/926)) ([14e1822](https://github.com/spotandjake/grain/commit/14e18229f82637870c651b948fb15c3e5a7b082c))
* **compiler:** Preserve all configs when compiling ([#1207](https://github.com/spotandjake/grain/issues/1207)) ([d8ff903](https://github.com/spotandjake/grain/commit/d8ff9037fc3148384d2157f76e4394322ba4ed58))
...
* **compiler:** Properly apply bindings when executing match guard ([#1039](https://github.com/spotandjake/grain/issues/1039)) ([121644b](https://github.com/spotandjake/grain/commit/121644be48e66ea1a7ce884ea816fe9af223442c))
...
* **compiler:** Properly handle value restriction on function application & mutable vars ([#988](https://github.com/spotandjake/grain/issues/988)) ([ef0a69f](https://github.com/spotandjake/grain/commit/ef0a69fb4418d318b3227e5db7e743a026762274))
...
* **compiler:** Properly unmark type manifest bodies ([bc648ce](https://github.com/spotandjake/grain/commit/bc648ce98f1263cdb4163f7fd620de75771848ab))
...
* **compiler:** Read custom sections in full ([#1243](https://github.com/spotandjake/grain/issues/1243)) ([f8a0891](https://github.com/spotandjake/grain/commit/f8a0891f253e33153feb2ec20afe6443391a1aa8))
* **compiler:** Refactor WASI polyfill resolution ([#1261](https://github.com/spotandjake/grain/issues/1261)) ([a39b48f](https://github.com/spotandjake/grain/commit/a39b48ff95f4ef7ce5a4b5454dbc620ae4044c17))
* **compiler:** Remove <id></id> from default ident printer ([#1056](https://github.com/spotandjake/grain/issues/1056)) ([49cd5a0](https://github.com/spotandjake/grain/commit/49cd5a08e5d9b2753b47af324b7fb90f4a98b339))
* **compiler:** Remove existing exports when writing universal exports ([#919](https://github.com/spotandjake/grain/issues/919)) ([e80de43](https://github.com/spotandjake/grain/commit/e80de439e79ed1dab1c1adcbd5b9cca7a79be023))
...
* **compiler:** Report binop locations properly ([#1271](https://github.com/spotandjake/grain/issues/1271)) ([4b9dd9c](https://github.com/spotandjake/grain/commit/4b9dd9c35969cf86f1d2d9a8013b7f6d347c508e))
* **compiler:** Report Win32 instead of Cygwin in JS compiler ([#1251](https://github.com/spotandjake/grain/issues/1251)) ([584bcad](https://github.com/spotandjake/grain/commit/584bcad942f91d86c9b328e61f34af6e3cfbd050))
* **compiler:** Resolve all modules fully during linking ([#950](https://github.com/spotandjake/grain/issues/950)) ([33b33a3](https://github.com/spotandjake/grain/commit/33b33a3926cc059a0a759c4ec894fb9f6f03d904))
* **compiler:** Respect stack type when dropping statements ([#1138](https://github.com/spotandjake/grain/issues/1138)) ([5a44e93](https://github.com/spotandjake/grain/commit/5a44e93ab646f1e9998ce6c23245e41c4bf0019a))
* **compiler:** Supply correct error for unbound record labels ([#1200](https://github.com/spotandjake/grain/issues/1200)) ([86e1bc0](https://github.com/spotandjake/grain/commit/86e1bc0ba099c5b48ba72e98530a634e15f6bb77))
...
* **compiler:** Use option converter for `--profile` argument ([#1432](https://github.com/spotandjake/grain/issues/1432)) ([57776f2](https://github.com/spotandjake/grain/commit/57776f224904f2d422923a1a947b5acbe435cfa4))
* Correctly preserve start position for character literals ([#931](https://github.com/spotandjake/grain/issues/931)) ([8fcc575](https://github.com/spotandjake/grain/commit/8fcc575a3afde79ac6455b35839b1bcdd6ded41f))
...
* **graindoc:** Avoid singletons when building ordered comments ([#1208](https://github.com/spotandjake/grain/issues/1208)) ([3f28e6e](https://github.com/spotandjake/grain/commit/3f28e6e226bbd951aedc6f8783203152919c7d08))
...
* **graindoc:** Ensure value_description is resolved to outcome before printing ([#1070](https://github.com/spotandjake/grain/issues/1070)) ([5eb05cc](https://github.com/spotandjake/grain/commit/5eb05cc2dedc3b933e194be86dd5d3c3656d6490))
...
* **graindoc:** Fix type printing for types and abstract types ([#1238](https://github.com/spotandjake/grain/issues/1238)) ([aea3ea9](https://github.com/spotandjake/grain/commit/aea3ea9f6b72182dfffb8af4c9af83a444fb6a83))
...
* **graindoc:** Only extract attributes from Doc comments ([#970](https://github.com/spotandjake/grain/issues/970)) ([7b6ee5f](https://github.com/spotandjake/grain/commit/7b6ee5f085af89f3db181c8d6c2718ca161f2ead))
* **graindoc:** Preserve indentation in Doc comments during trim ([#1119](https://github.com/spotandjake/grain/issues/1119)) ([b8a6d57](https://github.com/spotandjake/grain/commit/b8a6d57cce274bfbc2cc16c5b25215b042d4264c))
...
* **graindoc:** Remove special idents from receiving parens ([#1104](https://github.com/spotandjake/grain/issues/1104)) ([5cb0fda](https://github.com/spotandjake/grain/commit/5cb0fda652cad0644f48d8196089430dca1cac0d))
...
* **graindoc:** Use value_descriptions and type_declarations defined by the module signature ([#1241](https://github.com/spotandjake/grain/issues/1241)) ([5896242](https://github.com/spotandjake/grain/commit/5896242c324622f3329c144bd2c9642aade9d049))
...
* **grainfmt:** Break long parameterized types ([bc648ce](https://github.com/spotandjake/grain/commit/bc648ce98f1263cdb4163f7fd620de75771848ab))
...
* **grainfmt:** fix some spacing issues with the formatter ([#955](https://github.com/spotandjake/grain/issues/955)) ([9c4be85](https://github.com/spotandjake/grain/commit/9c4be85011d6c030fd54954bd86b0a3ee0f80660))
* **grainfmt:** Format CRLF files without error ([#941](https://github.com/spotandjake/grain/issues/941)) ([ece7536](https://github.com/spotandjake/grain/commit/ece7536b6d20694360257515a6f963f115ed21b3))
...
* **grainfmt:** Group infix functions when passed as params ([bb9666d](https://github.com/spotandjake/grain/commit/bb9666d24991df94c82d4f50c1d25d7669cec3c9))
...
* **grainfmt:** Handle comments within lists ([#1429](https://github.com/spotandjake/grain/issues/1429)) ([05b5f52](https://github.com/spotandjake/grain/commit/05b5f525fea50db20b49b4b5cb88c4b0259d2805))
* **grainfmt:** handle empty type for foreign exports ([#907](https://github.com/spotandjake/grain/issues/907)) ([d3b60a4](https://github.com/spotandjake/grain/commit/d3b60a422568941185c2446464ba2eeb4a776ed2))
...
* **grainfmt:** Handle recursive enums ([7dc77cd](https://github.com/spotandjake/grain/commit/7dc77cd3ec28745dfad6cdbd1551c09a82a1ba6b))
...
* **grainfmt:** Improve correctness of formatting ([9bc7a55](https://github.com/spotandjake/grain/commit/9bc7a55a525c8018e9d915cf94af2f2486a21e27))
* **grainfmt:** Improve formatter performance ([#959](https://github.com/spotandjake/grain/issues/959)) ([4e739f1](https://github.com/spotandjake/grain/commit/4e739f1d12a1493207a81549f1c0145f296b50be))
* **grainfmt:** Indent function application args when adding parens ([#1095](https://github.com/spotandjake/grain/issues/1095)) ([64af7d3](https://github.com/spotandjake/grain/commit/64af7d387dca2fddb9b3d190ccdf5790ec3d8e65))
...
* **grainfmt:** Inform the formatter that it is running against root files ([b58323f](https://github.com/spotandjake/grain/commit/b58323f1764f4d870875b8c4ef19f9861b4188ad))
...
* **grainfmt:** Preserve the EOL characters of file ([#1216](https://github.com/spotandjake/grain/issues/1216)) ([ef2835a](https://github.com/spotandjake/grain/commit/ef2835a5608cb1d5de52b280b6d4fd5b563ce725))
* **grainfmt:** Print attributes for non-toplevel expressions ([#887](https://github.com/spotandjake/grain/issues/887)) ([72292fe](https://github.com/spotandjake/grain/commit/72292fe67cb21905dd976933d278810ac49bd35b))
...
* **grainfmt:** Properly handle if/then/else line breaks ([#1217](https://github.com/spotandjake/grain/issues/1217)) ([93fd3b5](https://github.com/spotandjake/grain/commit/93fd3b5d0a5ccbc11baaab08d0f65ff9ec98aead))
...
* **grainfmt:** remove extra spaces around for/while loop conditions ([#897](https://github.com/spotandjake/grain/issues/897)) ([2054a83](https://github.com/spotandjake/grain/commit/2054a832d713cd335417fe6e04e537453045c43f))
* **grainfmt:** Remove extra spacing from type signatures ([#877](https://github.com/spotandjake/grain/issues/877)) ([c8cf421](https://github.com/spotandjake/grain/commit/c8cf421940fb21c06c5e3f9a11c72670bccccfb2))
* **grainfmt:** Remove extraneous parens around infix function application ([#902](https://github.com/spotandjake/grain/issues/902)) ([5c1906a](https://github.com/spotandjake/grain/commit/5c1906a98664f1b14f969fff5c0e48ddd08988c4))
* **grainfmt:** Remove parens around annotated types ([#1109](https://github.com/spotandjake/grain/issues/1109)) ([0ca66bd](https://github.com/spotandjake/grain/commit/0ca66bd43703826f86ef5b28b49d250af219fb0b))
* **grainfmt:** Removed a trailing comma after a spread in a list, and fixed escaped single quote ([#923](https://github.com/spotandjake/grain/issues/923)) ([3a138d6](https://github.com/spotandjake/grain/commit/3a138d6002fdb2a84df89355e10a143ff792b122))
* **grainfmt:** Resolve issues with comments within braces ([#888](https://github.com/spotandjake/grain/issues/888)) ([9c88b89](https://github.com/spotandjake/grain/commit/9c88b89db4ce1d7a256cbde51d74225513b76a3e))
* **grainfmt:** Resugar match lists properly ([7dc77cd](https://github.com/spotandjake/grain/commit/7dc77cd3ec28745dfad6cdbd1551c09a82a1ba6b))
* **grainfmt:** Scope the comments in callback lambda closure ([#1090](https://github.com/spotandjake/grain/issues/1090)) ([0975580](https://github.com/spotandjake/grain/commit/09755801d8598691e4a2884a732c0ed9a9e10a2d))
...
* **grainfmt:** Use Doc.space and surround trailing type annotations with parens ([#866](https://github.com/spotandjake/grain/issues/866)) ([7bad8e2](https://github.com/spotandjake/grain/commit/7bad8e2afb00b3756c191acc2181acefd28ed7fc))
...
* **grainfmt:** Wrap type annotation for a long line let assignment ([#1005](https://github.com/spotandjake/grain/issues/1005)) ([963b505](https://github.com/spotandjake/grain/commit/963b5053b57aece6b721bd99dbe143b117ad86d7))
...
* **linking:** Close file after reading ([c404fcf](https://github.com/spotandjake/grain/commit/c404fcf30bceab2911d3ab0c99f284791c799ca0))
...
* Properly open & close files ([#985](https://github.com/spotandjake/grain/issues/985)) ([c404fcf](https://github.com/spotandjake/grain/commit/c404fcf30bceab2911d3ab0c99f284791c799ca0))
* **runtime:** Add types to boxed GC functions to avoid weak type errors ([ef0a69f](https://github.com/spotandjake/grain/commit/ef0a69fb4418d318b3227e5db7e743a026762274))
...
* **stdlib:** Add bounds checking to Buffer addStringSlice & addBytesSlice ([#1065](https://github.com/spotandjake/grain/issues/1065)) ([06fe512](https://github.com/spotandjake/grain/commit/06fe512e863aeeb855ccf3e3b83bcd3bc8854723))
* **stdlib:** Add explicit void return type on Map.forEach ([#1220](https://github.com/spotandjake/grain/issues/1220)) ([ab2066a](https://github.com/spotandjake/grain/commit/ab2066aadffa8813344d9df7c7a10ec0f76751b6))
* **stdlib:** Add explicit void return type on Set.forEach ([#1225](https://github.com/spotandjake/grain/issues/1225)) ([694e6cf](https://github.com/spotandjake/grain/commit/694e6cf8fcd061a77b2915dc0ea9e9b1ae143ae4))
* **stdlib:** Align Buffer's `addStringSlice` API with String's `slice` ([#1136](https://github.com/spotandjake/grain/issues/1136)) ([0c7cb82](https://github.com/spotandjake/grain/commit/0c7cb820d49cda74598680cc614c0d893b4d2b40))
* **stdlib:** Annotate generic types in Buffer ([#876](https://github.com/spotandjake/grain/issues/876)) ([ad46b9e](https://github.com/spotandjake/grain/commit/ad46b9e6b0d2d9d562b56e5cbf1ae6751028d93a))
* **stdlib:** Buffer.toBytes should not expose the raw instance of Bytes used by the buffer ([#1130](https://github.com/spotandjake/grain/issues/1130)) ([d2bb585](https://github.com/spotandjake/grain/commit/d2bb585d3e2092f1331a679f4e84a9500b8c87a5))
* **stdlib:** Correct fdPwrite return value ([#875](https://github.com/spotandjake/grain/issues/875)) ([ceaf6af](https://github.com/spotandjake/grain/commit/ceaf6af52889f5d7c8a16df9a5a9ae5ff6752105))
* **stdlib:** Correct type signatures on some Array functions ([#880](https://github.com/spotandjake/grain/issues/880)) ([04bf4d3](https://github.com/spotandjake/grain/commit/04bf4d3066cf80de8cb3da834124e29558c6d21a))
...
* **stdlib:** Fix Char.code memory issue ([#928](https://github.com/spotandjake/grain/issues/928)) ([dfa31d8](https://github.com/spotandjake/grain/commit/dfa31d8aa60a41d08494f3817bdb628a30d83f41))
* **stdlib:** Fix float printing in dtoa ([#1165](https://github.com/spotandjake/grain/issues/1165)) ([2987210](https://github.com/spotandjake/grain/commit/2987210648873ab474990ff2b7146a489fecb268))
...
* **stdlib:** Fix issue with list printing ([#894](https://github.com/spotandjake/grain/issues/894)) ([e2a33a9](https://github.com/spotandjake/grain/commit/e2a33a9607bd076abbf6375389f1a7896775e6bc))
* **stdlib:** Fix memory issue in list printing ([#912](https://github.com/spotandjake/grain/issues/912)) ([3e0a805](https://github.com/spotandjake/grain/commit/3e0a8059a36d1042fa06d6aed54565ced116fd87))
* **stdlib:** Fix memory leaks in Char stdlib ([#929](https://github.com/spotandjake/grain/issues/929)) ([99cc94b](https://github.com/spotandjake/grain/commit/99cc94b3e2010c7fa6b2c244758dbbe13e43f903))
...
* **stdlib:** Fix String.encode GC ([#1067](https://github.com/spotandjake/grain/issues/1067)) ([0ab38c9](https://github.com/spotandjake/grain/commit/0ab38c9f4aa0ee84688ba5c6bec1521b380d38b1))
* **stdlib:** Fixed a memory leak in Buffer.addStringSlice. ([#1122](https://github.com/spotandjake/grain/issues/1122)) ([c4e1911](https://github.com/spotandjake/grain/commit/c4e19110bd9923e58a7953fcbcef18bf07f3efd6))
* **stdlib:** Fixed length and byteLength for strings over 2GiB. ([#1126](https://github.com/spotandjake/grain/issues/1126)) ([08a9487](https://github.com/spotandjake/grain/commit/08a948709270a9aa4ac853c2887bc652c4734f36))
* **stdlib:** Fixed memory leak in String.explode ([#1001](https://github.com/spotandjake/grain/issues/1001)) ([c479a05](https://github.com/spotandjake/grain/commit/c479a05f48abcc4c9e98d5cf0ba698230d41031b))
* **stdlib:** Make Bytes.length handle sizes over 2GiB ([#1123](https://github.com/spotandjake/grain/issues/1123)) ([d7386eb](https://github.com/spotandjake/grain/commit/d7386eb36c32452d69a734b447015b4db23f1ac4))
...
* **stdlib:** Premature free in toString ([#863](https://github.com/spotandjake/grain/issues/863)) ([eec0f09](https://github.com/spotandjake/grain/commit/eec0f092987cd6c9ddd7519b139596611dd84d7c))
...
* **stdlib:** Remove intermediate resizes in Buffer.autogrow ([#1125](https://github.com/spotandjake/grain/issues/1125)) ([c1695d0](https://github.com/spotandjake/grain/commit/c1695d066ccd40b3118c5c870353addeef67bfc1))
...
* **stdlib:** Removed memory leak in Hash module ([#1045](https://github.com/spotandjake/grain/issues/1045)) ([01a81c6](https://github.com/spotandjake/grain/commit/01a81c6a2573cca94b2d57d0fc70693d39f810a1))
* **stdlib:** Removed memory leaks in Buffer module ([#1047](https://github.com/spotandjake/grain/issues/1047)) ([d33017b](https://github.com/spotandjake/grain/commit/d33017b37e988d3facbca2e30e3de4fb8c7b5b8a))
* **stdlib:** Support arrays of any type in Array rotate ([#1048](https://github.com/spotandjake/grain/issues/1048)) ([3ceb1cf](https://github.com/spotandjake/grain/commit/3ceb1cf04c1604f49077e8733dcccb6cdaaf9f3a))
* **stdlib:** Support empty arrays in Array rotate ([3ceb1cf](https://github.com/spotandjake/grain/commit/3ceb1cf04c1604f49077e8733dcccb6cdaaf9f3a))
...
* **stdlib:** Use random seed for hash module ([#854](https://github.com/spotandjake/grain/issues/854)) ([a1a42d8](https://github.com/spotandjake/grain/commit/a1a42d89893fe97e8557c34a8d8e1884735299bc))
...
* **compiler:** Add interface for compile module to hide resume ([d8ff903](https://github.com/spotandjake/grain/commit/d8ff9037fc3148384d2157f76e4394322ba4ed58))
* **compiler:** Disallow end-of-line before `=>` ([#1178](https://github.com/spotandjake/grain/issues/1178)) ([8261e73](https://github.com/spotandjake/grain/commit/8261e733c9345c690ffc107616512be4eb4c469e))
...
* Drop node 14 support ([#1092](https://github.com/spotandjake/grain/issues/1092)) ([ef4358f](https://github.com/spotandjake/grain/commit/ef4358ff7de14a35edf3e971e04513d497fe1574))
...
* **stdlib:** Add type aliases to regex lib ([#1036](https://github.com/spotandjake/grain/issues/1036)) ([a926ea5](https://github.com/spotandjake/grain/commit/a926ea5cafa18e46487a585abbdf5460b15b4f48))
...
* Switch from yarn to npm ([#1226](https://github.com/spotandjake/grain/issues/1226)) ([5ea9274](https://github.com/spotandjake/grain/commit/5ea92743a05fffb4298deda64100a3d7fc2259cb))
