...
## [0.8.0](https://github.com/spotandjake/grain/compare/grain-v0.7.2...grain-v0.8.0) (2026-07-10)


### ⚠ BREAKING CHANGES

* **cli:** Require node `>=22.13` ([#2256](https://github.com/spotandjake/grain/issues/2256))
* **compiler:** Disallow whitespace for negative literals + allow infix operators on new line ([#2136](https://github.com/spotandjake/grain/issues/2136))
* **compiler:** Custom Grain object files ([#2104](https://github.com/spotandjake/grain/issues/2104))
* Remove `->` token in favor of `=>` ([#2177](https://github.com/spotandjake/grain/issues/2177))
* **stdlib:** Seeded hashing ([#2170](https://github.com/spotandjake/grain/issues/2170))
...
* **graindoc:** Remove section attribute ([#1681](https://github.com/spotandjake/grain/issues/1681))
...
* Add `getAll`, `setAll`, `removeAll` to `List.Associative` ([#2224](https://github.com/spotandjake/grain/issues/2224)) ([9c49a23](https://github.com/spotandjake/grain/commit/9c49a23666f59c90499491ab2501214a33439fa1))
...
* **compiler:** Allow non-block bodies with loops ([#2064](https://github.com/spotandjake/grain/issues/2064)) ([6fd1603](https://github.com/spotandjake/grain/commit/6fd16037cd6ab34cb6dce18e6945c7fad0a54611))
...
* **compiler:** Correct lexer error in malformed match ([#2370](https://github.com/spotandjake/grain/issues/2370)) ([8a8a906](https://github.com/spotandjake/grain/commit/8a8a906a5ec121d908596e3f6bc15623d3243a2f))
...
* **compiler:** Deduplicate foreign imports ([#2233](https://github.com/spotandjake/grain/issues/2233)) ([e8a3ed2](https://github.com/spotandjake/grain/commit/e8a3ed2a04713748ba7c577a04ae8f588844430c))
* **compiler:** Disallow whitespace for negative literals + allow infix operators on new line ([#2136](https://github.com/spotandjake/grain/issues/2136)) ([3186155](https://github.com/spotandjake/grain/commit/318615583c1a1dbea3a7ea6c1c616bcac4df2c0a))
...
* **compiler:** Improve exhaustive warning for lists ([#2220](https://github.com/spotandjake/grain/issues/2220)) ([f54dbdf](https://github.com/spotandjake/grain/commit/f54dbdf2a7d7e0e75c0bd22c9ad5eaab0259b177))
...
* **compiler:** Provide a user friendly error on `_start` override ([#2351](https://github.com/spotandjake/grain/issues/2351)) ([37a64f9](https://github.com/spotandjake/grain/commit/37a64f974fd8cacb8f5b57329c75e09faea3cc41))
* **compiler:** Providing, including, reproviding exceptions ([#1849](https://github.com/spotandjake/grain/issues/1849)) ([687e747](https://github.com/spotandjake/grain/commit/687e747fb5d4c242d3bfceec6541ade58f6863a8))
...
* **compiler:** Support raising multiple well formedness errors. ([#2348](https://github.com/spotandjake/grain/issues/2348)) ([14db204](https://github.com/spotandjake/grain/commit/14db204b60e3416c9ead886c1b9c056ffb110a85))
...
* **compiler:** Test typemetadata size ([#2352](https://github.com/spotandjake/grain/issues/2352)) ([5314e33](https://github.com/spotandjake/grain/commit/5314e3308ed20a8f191d1ff96a8647105ab1d8e2))
...
* **compiler:** Upgrade to Binaryen v124 ([#2333](https://github.com/spotandjake/grain/issues/2333)) ([fafad72](https://github.com/spotandjake/grain/commit/fafad72bb8b41c38a0a363fe743bbb57324a2a9d))
* **compiler:** Use Binaryen's bulk memory polyfill ([#2334](https://github.com/spotandjake/grain/issues/2334)) ([1c5478e](https://github.com/spotandjake/grain/commit/1c5478e22a2cca7ff9f5198b768a2aa3c23fd4cf))
* **compiler:** Use location for `Unbound_label_with_alt` error ([#2196](https://github.com/spotandjake/grain/issues/2196)) ([271d7cb](https://github.com/spotandjake/grain/commit/271d7cb3617eb016215f58c5db431a8ab513d491))
* **compiler:** Use program location for `_gmain` ([#2231](https://github.com/spotandjake/grain/issues/2231)) ([bdbbd05](https://github.com/spotandjake/grain/commit/bdbbd05b467d54f11413952480e9c90cc0c06900))
* **docs:** Update `stdlib` contributor guidelines ([#2277](https://github.com/spotandjake/grain/issues/2277)) ([9631e72](https://github.com/spotandjake/grain/commit/9631e723063d92580b95f5fd384441244ec1dfac))
...
* **fmt:** Add trailing comma on inline records ([#2266](https://github.com/spotandjake/grain/issues/2266)) ([cbe12e2](https://github.com/spotandjake/grain/commit/cbe12e294d71fdfcefd8d7c59c5c586fc1fdcc48))
...
* **graindoc:** Add locations to Graindoc errors ([#2291](https://github.com/spotandjake/grain/issues/2291)) ([da6090a](https://github.com/spotandjake/grain/commit/da6090ad05d4e26c546f7bc13bec95c658f0e569))
* **graindoc:** Add test harness ([#1767](https://github.com/spotandjake/grain/issues/1767)) ([8a93ebe](https://github.com/spotandjake/grain/commit/8a93ebeebafe5938448e7e2968c6a48b90d43e3c))
...
* **graindoc:** Pretty markdown tables ([#2292](https://github.com/spotandjake/grain/issues/2292)) ([1992734](https://github.com/spotandjake/grain/commit/1992734e4e3126b8b9da37bad7510235640004ad))
...
* **grainlsp:** Add inlay types ([#2005](https://github.com/spotandjake/grain/issues/2005)) ([f8a8f7f](https://github.com/spotandjake/grain/commit/f8a8f7f7d81abbc79f6359b20c06e8164c20053a))
...
* **lsp:** Add or remove block braces code action ([#2222](https://github.com/spotandjake/grain/issues/2222)) ([3134504](https://github.com/spotandjake/grain/commit/31345048249ddcb2cba481edccfcf0aaccb6cae1))
* **lsp:** Add submodule information to module hover ([#2309](https://github.com/spotandjake/grain/issues/2309)) ([227b3e3](https://github.com/spotandjake/grain/commit/227b3e3e21a8d724ac7001923cce9a2958e98d6b))
* **lsp:** Disable code lenses on `records` & `enums` ([#2394](https://github.com/spotandjake/grain/issues/2394)) ([495e5dd](https://github.com/spotandjake/grain/commit/495e5ddc1148fc4ee2e855ed092e7c9cedd34872))
...
* **lsp:** Implement document symbol outline ([#2298](https://github.com/spotandjake/grain/issues/2298)) ([e4caac2](https://github.com/spotandjake/grain/commit/e4caac285db5b9dc2791d07385dd533d6c7ab79f))
* **lsp:** Support displaying multiple errors in the lsp ([#2354](https://github.com/spotandjake/grain/issues/2354)) ([4850458](https://github.com/spotandjake/grain/commit/4850458234f464a419fe0279377e154f7ce76c58))
...
* Remove `-&gt;` token in favor of `=>` ([#2177](https://github.com/spotandjake/grain/issues/2177)) ([d0038d3](https://github.com/spotandjake/grain/commit/d0038d34e95f4357b06101cb14aae57a3b928b51))
...
* **runtime:** Optimize `==` for lists  ([#2247](https://github.com/spotandjake/grain/issues/2247)) ([1cba005](https://github.com/spotandjake/grain/commit/1cba005db44163e2d197c4af14f1c3d8997ebbf8))
...
* **runtime:** Prevent stack overflow while collecting large lists ([#2248](https://github.com/spotandjake/grain/issues/2248)) ([097ae7d](https://github.com/spotandjake/grain/commit/097ae7d403aaabe20fba373564562274b9ff38d3))
...
* **stdlib:** `List.Associative` Submodule ([#2202](https://github.com/spotandjake/grain/issues/2202)) ([fbb08bf](https://github.com/spotandjake/grain/commit/fbb08bf28683b05fb77a57af6a787907da070ef7))
...
* **stdlib:** Add `Array.tryInit` ([#2209](https://github.com/spotandjake/grain/issues/2209)) ([218ff78](https://github.com/spotandjake/grain/commit/218ff780c824a12bbfa2a78c12d84a66e65a4931))
...
* **stdlib:** Add `Buffer.getChar` ([#2262](https://github.com/spotandjake/grain/issues/2262)) ([95d03cb](https://github.com/spotandjake/grain/commit/95d03cb97e67c05d0e7464a847cb8b0724bb28c8))
* **stdlib:** Add `Bytes.setChar` and `Bytes.getChar` ([#2215](https://github.com/spotandjake/grain/issues/2215)) ([4919ba3](https://github.com/spotandjake/grain/commit/4919ba3fbf584eecd2c9db40ee74ac0c70bf92bd))
* **stdlib:** Add `Char.encodedLength` ([#2238](https://github.com/spotandjake/grain/issues/2238)) ([c549fac](https://github.com/spotandjake/grain/commit/c549facdd1cc8efb2d20e7efeb512e19e4a9fbab))
...
* **stdlib:** Add `Exception.toString` ([#2143](https://github.com/spotandjake/grain/issues/2143)) ([0894dc5](https://github.com/spotandjake/grain/commit/0894dc551c4aad678e39e9de29919bb17a0ea23e))
...
* **stdlib:** Add `List.filterMap`, `List.filterMapi`, `List.findMap` ([#2201](https://github.com/spotandjake/grain/issues/2201)) ([551f5ad](https://github.com/spotandjake/grain/commit/551f5adf8f36e601657fbdda7e3c546acd71f916))
...
* **stdlib:** add `Path.removeExtension` ([#2226](https://github.com/spotandjake/grain/issues/2226)) ([7b7acfd](https://github.com/spotandjake/grain/commit/7b7acfd5b7e12d2d490b9f3ff3b28911ef9240e7))
* **stdlib:** Add `Path.updateExtension` ([#2282](https://github.com/spotandjake/grain/issues/2282)) ([6d795d0](https://github.com/spotandjake/grain/commit/6d795d059fcc6107719e4149ee4697a10a5941a8))
...
* **stdlib:** Add `String.repeat` to `String` module ([#2140](https://github.com/spotandjake/grain/issues/2140)) ([6c33d08](https://github.com/spotandjake/grain/commit/6c33d08ddabdc57e27ddc9b5595d5ae1fd9bf37d))
...
* **stdlib:** Add `toList`, `fromList`, `toArray`, `fromArray` to Stack ([#2198](https://github.com/spotandjake/grain/issues/2198)) ([b815bcd](https://github.com/spotandjake/grain/commit/b815bcd17fe083846b1b8aac94fd0ceffca544cc))
...
* **stdlib:** Add user-friendly file system module ([#1966](https://github.com/spotandjake/grain/issues/1966)) ([c4f638e](https://github.com/spotandjake/grain/commit/c4f638eaf0f7049dd3cfec96791f7d7ba22531f6))
...
* **stdlib:** Deprecate `Buffer.set` operations in favour of `Bytes.set` ([#2303](https://github.com/spotandjake/grain/issues/2303)) ([684df98](https://github.com/spotandjake/grain/commit/684df98c8329f6ddd7fab1294e97728a4a44887f))
* **stdlib:** Expose equality operators through `Number` module ([#2296](https://github.com/spotandjake/grain/issues/2296)) ([5965dff](https://github.com/spotandjake/grain/commit/5965dfff2e43f2f84651c32fe3ef2060613f245d))
...
* **stdlib:** Implement `reinterpret` between float and int values ([#2257](https://github.com/spotandjake/grain/issues/2257)) ([e3a4eac](https://github.com/spotandjake/grain/commit/e3a4eacb9a57caa6f45890d04233c7aa8abdfb08))
...
* **stdlib:** Optimize `List.init` to support large lists ([#2249](https://github.com/spotandjake/grain/issues/2249)) ([3de64ba](https://github.com/spotandjake/grain/commit/3de64ba88cb3e18fedd60175ce2b5e03e3d398ce))
...
* **stdlib:** Seeded hashing ([#2170](https://github.com/spotandjake/grain/issues/2170)) ([ce872ab](https://github.com/spotandjake/grain/commit/ce872ab718577ebd4d46857a2f3f7bb08c58efe4))
...
* **stdlib:** Standardize `path` module examples ([#2325](https://github.com/spotandjake/grain/issues/2325)) ([c6e3cb0](https://github.com/spotandjake/grain/commit/c6e3cb052e5ec69be8037dc63bf39ee2630bbccc))
...
* **compiler:** Correct `in_function` state when typing record properties ([#2205](https://github.com/spotandjake/grain/issues/2205)) ([d9dd274](https://github.com/spotandjake/grain/commit/d9dd274d473fbb88968adf80fa32bbc5bcee8700))
* **compiler:** Correct `Include_module_name_mismatch` error ([#2261](https://github.com/spotandjake/grain/issues/2261)) ([ef77a31](https://github.com/spotandjake/grain/commit/ef77a31d33c3481340403992f0611c5dec96a15c))
* **compiler:** Correct exhaustive check on record adt with when pattern ([#2355](https://github.com/spotandjake/grain/issues/2355)) ([5e372e5](https://github.com/spotandjake/grain/commit/5e372e56a2b373c4166143f782990519f5733eb9))
* **compiler:** Correct impossible bug on nested char pattern ([#2310](https://github.com/spotandjake/grain/issues/2310)) ([cd3267c](https://github.com/spotandjake/grain/commit/cd3267ca00ab0f5499445cccaccc6049b27688a2))
* **compiler:** Correct location of parmatch mismatch type error ([#2259](https://github.com/spotandjake/grain/issues/2259)) ([eb85692](https://github.com/spotandjake/grain/commit/eb85692c0a9f3cd72baf609f21a21e6557435f8e))
...
* **compiler:** Correct parsetree caching behaviour ([#2280](https://github.com/spotandjake/grain/issues/2280)) ([5f3f54d](https://github.com/spotandjake/grain/commit/5f3f54dc3aec2d7f7dd22c4121b2180d442be635))
...
* **compiler:** Correct type printing of `type A&lt;a&gt; = a` ([#2302](https://github.com/spotandjake/grain/issues/2302)) ([ac892d1](https://github.com/spotandjake/grain/commit/ac892d1f9a96d570aff122d82e22a2df8c5177ee))
* **compiler:** Correctly handle and backpatch mutually recursive closure scope functions ([#1808](https://github.com/spotandjake/grain/issues/1808)) ([c2a0c5b](https://github.com/spotandjake/grain/commit/c2a0c5baa7664a38ded3977455b8b9c2588c5034))
...
* **compiler:** Fix 'inconsistent assumptions over interface' bug ([#2253](https://github.com/spotandjake/grain/issues/2253)) ([66e5929](https://github.com/spotandjake/grain/commit/66e5929b0a511e211c427723364c4ebaf23e28da))
...
* **compiler:** Handle non-exhaustive record patterns ([#2274](https://github.com/spotandjake/grain/issues/2274)) ([0431e74](https://github.com/spotandjake/grain/commit/0431e74b1e0a02ec22fd46871aa5f5f8d8dd1649))
...
* **compiler:** Prevent impossible string error from pattern matching ([#2218](https://github.com/spotandjake/grain/issues/2218)) ([a1caf87](https://github.com/spotandjake/grain/commit/a1caf87c2141c27a026813d9d2af9dcbb3d21a7b))
...
* **compiler:** Reduce stack usage when allocating lists ([#2214](https://github.com/spotandjake/grain/issues/2214)) ([cad45e4](https://github.com/spotandjake/grain/commit/cad45e4b514a2e86867953e9782b348ce49dfaef))
...
* **compiler:** Resolve Not_found for use statements with module aliases ([#2285](https://github.com/spotandjake/grain/issues/2285)) ([fd2dbef](https://github.com/spotandjake/grain/commit/fd2dbefd4e950eef94aac9a19f6eafa2cb5f930e))
...
* **compiler:** Write universal exports on linked module ([#2234](https://github.com/spotandjake/grain/issues/2234)) ([2dba010](https://github.com/spotandjake/grain/commit/2dba010ef640fbe821c45c690d28dd85e3016095))
...
* **grainc:** Correct behaviour of `-o` flag ([#2270](https://github.com/spotandjake/grain/issues/2270)) ([3124ede](https://github.com/spotandjake/grain/commit/3124ede080f04b72c680a726cfe97d5fdac68e92))
...
* **grainfmt:** correct fmt of operator funcs applied with labeled args ([#2251](https://github.com/spotandjake/grain/issues/2251)) ([30f5cc3](https://github.com/spotandjake/grain/commit/30f5cc3987ad42be2fa31c59b356d31cb7bb5590))
* **grainfmt:** Correct formatting of nested constraints ([#2245](https://github.com/spotandjake/grain/issues/2245)) ([bdb7f7c](https://github.com/spotandjake/grain/commit/bdb7f7caf72e3f24c43586354044a7940c0e51a9))
* **grainfmt:** Correct formatting of record assignments ([#2344](https://github.com/spotandjake/grain/issues/2344)) ([7786d60](https://github.com/spotandjake/grain/commit/7786d6009903b294d2e3e1b005264ad820551ec2))
* **grainfmt:** Correct formatting of single arc function callback ([#2340](https://github.com/spotandjake/grain/issues/2340)) ([3ea198c](https://github.com/spotandjake/grain/commit/3ea198cd987600d45c27929cf54fdb5962381dae))
* **grainfmt:** Correct formatting of submodules ending with comments ([#2288](https://github.com/spotandjake/grain/issues/2288)) ([f969df9](https://github.com/spotandjake/grain/commit/f969df9816bf2c4aa22bc2a658de1f1d743a32b9))
...
* **grainfmt:** Fix formatting of function types with a single tuple arg ([#2230](https://github.com/spotandjake/grain/issues/2230)) ([13ac7fa](https://github.com/spotandjake/grain/commit/13ac7fadc031039aa3661054161c3b1b5e3b1564))
...
* **lsp:** Correct use argument label code_action with inferred funcs ([#2283](https://github.com/spotandjake/grain/issues/2283)) ([7d4fd44](https://github.com/spotandjake/grain/commit/7d4fd4412ed4f2b9e33b7faa9ac3889c3d15872b))
* **lsp:** Ensure file changes update lsp state ([#2267](https://github.com/spotandjake/grain/issues/2267)) ([031e39a](https://github.com/spotandjake/grain/commit/031e39aed1a1b0946954f5827da26802b390b220))
...
* **lsp:** Make exit a notification instead of a request ([#2393](https://github.com/spotandjake/grain/issues/2393)) ([0dcc049](https://github.com/spotandjake/grain/commit/0dcc049f636d11bc857b158465c53c3831dc543e))
* **lsp:** make spec complient JSON-RPC response and properly implement definition link suport ([#2392](https://github.com/spotandjake/grain/issues/2392)) ([dd5de75](https://github.com/spotandjake/grain/commit/dd5de75e233b2b213267949da4a842fc2e62f374))
...
* **lsp:** Use correct origin selection range ([#2146](https://github.com/spotandjake/grain/issues/2146)) ([ab3dde8](https://github.com/spotandjake/grain/commit/ab3dde8a29a7dc93b8e952407b9ce305f34bb15b))
...
* **stdlib:** Correct bugs in regex parsing ([#2368](https://github.com/spotandjake/grain/issues/2368)) ([636a6e5](https://github.com/spotandjake/grain/commit/636a6e5cc5e5bab0027ca207cf5af2b1edca6e21))
...
* **stdlib:** correct the behavior of float pow opperations ([#2366](https://github.com/spotandjake/grain/issues/2366)) ([126a4c4](https://github.com/spotandjake/grain/commit/126a4c4318be081b45610ccd8417491ac64bc48c))
...
* **stdlib:** Properly resize empty Queue on push ([#1865](https://github.com/spotandjake/grain/issues/1865)) ([f7727ef](https://github.com/spotandjake/grain/commit/f7727ef2158f63dc8c88a5b824b41e31495f0f51))
